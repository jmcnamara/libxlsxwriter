...
int main() {
    ...
    worksheet_write_string(worksheet, 0, 0, "Cell B1 is locked. It cannot be edited.",       NULL);
    worksheet_write_string(worksheet, 1, 0, "Cell B2 is unlocked. It can be edited.",        NULL);
    worksheet_write_string(worksheet, 2, 0, "Cell B3 is hidden. The formula isn't visible.", NULL);
