...
int main() {
    ...
    chart1->axis_id_3 = 114988928;
    chart1->axis_id_4 = 114987392;
    ...
    /* Set font properties on primary and secondary Y axes. */
    lxw_chart_font font = {.bold = LXW_TRUE, .baseline = -1};

    chart_axis_set_num_font(chart1->y_axis, &font);
    chart_axis_set_num_font(chart1->y2_axis, &font);
