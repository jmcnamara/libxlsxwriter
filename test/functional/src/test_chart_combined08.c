...
int main() {
    ...
    lxw_workbook  *workbook  = workbook_new("test_chart_combined08.xlsx");
    ...
    chart2->axis_id_3 = 89510656;
    chart2->axis_id_4 = 84556032;
    ...
    lxw_chart_series *series2 = chart_add_series(chart2, "=Sheet1!$A$1:$A$5", "=Sheet1!$C$1:$C$5");
